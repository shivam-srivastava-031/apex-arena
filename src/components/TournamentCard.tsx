  ...
  return (
    <div className="gaming-card group flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 pt-4">
        <span className={`inline-flex rounded-md px-2.5 py-1 text-xs font-bold ${gameColors[tournament.gameType]}`}>
          {tournament.gameType}
        </span>
      ...
      <div className="flex flex-1 flex-col gap-3 p-4 pt-3">
        ...
        <div className="text-gradient font-display text-2xl font-black">
